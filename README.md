...
<ul>
  <li>	2captcha-python (https://pypi.org/project/2captcha-python/)</li>
  <li>	2captcha-solver  (https://pypi.org/project/2captcha-solver/)</li>
  <li>	captchatools  (https://pypi.org/project/captchatools/)</li>
  <li>	twocaptcha-extension-python  (https://pypi.org/project/twocaptcha-extension-python/)</li>
  <li>	Captcha-Tools  (https://github.com/Matthew17-21/Captcha-Tools)</li>
</ul>
<H2>2captcha-python</H2>
...
<p>Based on the fact that the module allows you to integrate captcha recognition through several services, it has a unique function – brute force search for services. That is, you can use one service as the main one, and others as backup, and when, for example, you run out of funds on the main service, or if the main service could not cope with the task, the captcha will go to the backup one and will be solved. This way your script will be more automated and will not depend on the stability of one particular service.</p>
<H2>Twocaptcha-extension-python</H2>
...
<H2>Modules for solving recaptcha in node js</H2>
...
<ul>
  <li> 2captcha  (https://www.npmjs.com/package/2captcha)</li>
  <li>	2captcha-javascript  (https://github.com/2captcha/2captcha-javascript)</li>
  <li>	captcha-solver  (https://www.npmjs.com/package/captcha-solver)</li>
  <li>	multi-captcha-solver-adapter  (https://www.npmjs.com/package/multi-captcha-solver-adapter?activeTab=readme)</li>
</ul>	
<H2>2captcha</H2>
...
<H2>Multi-captcha-solver-adapter</H2>
...
<H2>Modules for solving recaptcha in PHP</H2>
...
<ul>
  <li>2captcha-php (https://github.com/2captcha/2captcha-php/tree/master)</li>
  <li>php-captcha-solver (https://github.com/Athlon1600/php-captcha-solver)</li>
</ul>
<H2>2captcha-php</H2>
